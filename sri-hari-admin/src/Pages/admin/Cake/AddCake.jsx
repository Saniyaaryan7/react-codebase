      ...
      Premium Cakes
              ...
              <div>
                ...
                <div className="flex items-center gap-4 border rounded-lg px-3 py-2">
                  ...
                  <label
                    htmlFor="cakeImage"
                    className="cursor-pointer bg-gray-100 hover:bg-gray-200 text-sm px-4 py-2 rounded-md text-gray-700"
                  >
                    Choose File
                  </label>
            ...
            <div className="flex gap-4 mt-8">
              <button className="bg-[rgb(53,111,132)] hover:bg-[rgb(25,79,99)] text-white px-6 py-2 rounded-lg text-sm font-medium">
                Save Cake
              </button>

              <button className="border border-gray-300 hover:bg-gray-100 px-6 py-2 rounded-lg text-sm font-medium">
                Cancel
              </button>
            </div>
          </div>

...
export default function About() {
    ...
    <div className="w-full overflow-hidden">
      ...
      <section className="relative w-full h-[45vh] md:h-[60vh]">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white text-center px-4">
          ...
          <p className="mt-2 text-sm md:text-base">Sri Hari Sweets is a celebration of taste, tradition, and quality.</p>
        </div>
      </section>
  ...
  {/* Content */}
  <div className="relative max-w-7xl mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-center text-pink-700 ">
    {[
      {
        title: "Tradition",
      ...
      <div
        key={i}
        className="p-6 rounded-2xl bg-white/90 backdrop-blur shadow-md hover:shadow-xl transition"
      >
      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        ...
        <div className="relative text-center text-white max-w-3xl px-6">
          <h2 className="text-3xl font-semibold mb-4">Our Bakery</h2>
          <p className="leading-relaxed">
